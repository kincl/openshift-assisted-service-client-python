...
from openshift_assisted_service.models.install_cmd_request import InstallCmdRequest  # noqa: E501
...
class TestInstallCmdRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `InstallCmdRequest`
        """
        model = openshift_assisted_service.models.install_cmd_request.InstallCmdRequest()  # noqa: E501
        if include_optional :
            return InstallCmdRequest(
                cluster_id = '', 
                infra_env_id = '', 
                host_id = '', 
                role = 'auto-assign', 
                boot_device = '', 
                controller_image = 'A9LCS/o81.h5loqtqj-h9xz3do70@_i714-_@842en7idxm6i75z1t7di1ja.orkmt.8vv6f-n615ro.d3hvck0LlJwL5CTL', 
                installer_image = 'A9LCS/o81.h5loqtqj-h9xz3do70@_i714-_@842en7idxm6i75z1t7di1ja.orkmt.8vv6f-n615ro.d3hvck0LlJwL5CTL', 
                ...
                must_gather_image = '', 
                mco_image = 'A9LCS/o81.h5loqtqj-h9xz3do70@_i714-_@842en7idxm6i75z1t7di1ja.orkmt.8vv6f-n615ro.d3hvck0LlJwL5CTL', 
                openshift_version = '', 
                service_ips = [
                ...
                installer_args = '', 
                skip_installation_disk_cleanup = True
            )
        else :
            return InstallCmdRequest(
                cluster_id = '',
