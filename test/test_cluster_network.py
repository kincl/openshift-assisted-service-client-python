...
from openshift_assisted_service.models.cluster_network import ClusterNetwork  # noqa: E501
from openshift_assisted_service.rest import ApiException

class TestClusterNetwork(unittest.TestCase):
    """ClusterNetwork unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ClusterNetwork`
        """
        model = openshift_assisted_service.models.cluster_network.ClusterNetwork()  # noqa: E501
        if include_optional :
