...
from openshift_assisted_service.models.infra_env_update_params import InfraEnvUpdateParams  # noqa: E501
...
class TestInfraEnvUpdateParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `InfraEnvUpdateParams`
        """
        model = openshift_assisted_service.models.infra_env_update_params.InfraEnvUpdateParams()  # noqa: E501
        if include_optional :
            return InfraEnvUpdateParams(
