...
from openshift_assisted_service.models.service_network import ServiceNetwork  # noqa: E501
from openshift_assisted_service.rest import ApiException

class TestServiceNetwork(unittest.TestCase):
    """ServiceNetwork unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ServiceNetwork`
        """
        model = openshift_assisted_service.models.service_network.ServiceNetwork()  # noqa: E501
        if include_optional :
