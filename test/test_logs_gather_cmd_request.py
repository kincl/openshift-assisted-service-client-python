...
from openshift_assisted_service.models.logs_gather_cmd_request import LogsGatherCmdRequest  # noqa: E501
...
class TestLogsGatherCmdRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `LogsGatherCmdRequest`
        """
        model = openshift_assisted_service.models.logs_gather_cmd_request.LogsGatherCmdRequest()  # noqa: E501
        if include_optional :
            return LogsGatherCmdRequest(
                cluster_id = '', 
                infra_env_id = '', 
                host_id = '', 
                bootstrap = True, 
                installer_gather = True, 
                master_ips = [
