...
from openshift_assisted_service.models.connectivity_check_host import ConnectivityCheckHost  # noqa: E501
...
class TestConnectivityCheckHost(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ConnectivityCheckHost`
        """
        model = openshift_assisted_service.models.connectivity_check_host.ConnectivityCheckHost()  # noqa: E501
        if include_optional :
            return ConnectivityCheckHost(
                host_id = '', 
                nics = [
                    openshift_assisted_service.models.connectivity_check_nic.connectivity-check-nic(
                        name = '', 
                        mac = '', 
                        ip_addresses = [
