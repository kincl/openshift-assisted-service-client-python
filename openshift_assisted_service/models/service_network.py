...
class ServiceNetwork(BaseModel):
    ...
    """
    cluster_id: Optional[StrictStr] = Field(None, description="A network to use for service IP addresses. If you need to access the services from an external network, configure load balancers and routers to manage the traffic.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceNetwork:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceNetwork:
        """Create an instance of ServiceNetwork from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceNetwork.parse_obj(obj)

        _obj = ServiceNetwork.parse_obj({
