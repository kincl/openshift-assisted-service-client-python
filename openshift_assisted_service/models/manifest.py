...
class Manifest(BaseModel):
    ...
    Manifest
    """
    folder: Optional[StrictStr] = Field(None, description="The folder that contains the files. Manifests can be placed in 'manifests' or 'openshift' directories.")
    file_name: Optional[StrictStr] = Field(None, description="The file name prefaced by the folder that contains it.")
    __properties = ["folder", "file_name"]
