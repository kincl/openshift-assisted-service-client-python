...
class VerifyVip(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyVip:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyVip:
        """Create an instance of VerifyVip from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VerifyVip.parse_obj(obj)

        _obj = VerifyVip.parse_obj({
            "vip": obj.get("vip"),
