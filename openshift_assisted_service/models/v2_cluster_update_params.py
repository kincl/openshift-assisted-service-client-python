...
class V2ClusterUpdateParams(BaseModel):
    """
    V2ClusterUpdateParams
    """
    name: Optional[constr(strict=True, max_length=54, min_length=1)] = Field(None, description="OpenShift cluster name.")
    ...
    __properties = ["name", "base_dns_domain", "cluster_network_cidr", "platform", "cluster_network_host_prefix", "service_network_cidr", "api_vip", "api_vips", "ingress_vip", "ingress_vips", "api_vip_dns_name", "machine_network_cidr", "pull_secret", "ssh_public_key", "vip_dhcp_allocation", "http_proxy", "https_proxy", "no_proxy", "user_managed_networking", "additional_ntp_source", "olm_operators", "hyperthreading", "network_type", "schedulable_masters", "cluster_networks", "service_networks", "machine_networks", "disk_encryption", "ignition_endpoint", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2ClusterUpdateParams:
    ...
    def to_dict(self):
        ...
        # set to None if base_dns_domain (nullable) is None
        # and __fields_set__ contains the field
        if self.base_dns_domain is None and "base_dns_domain" in self.__fields_set__:
            _dict['base_dns_domain'] = None

        # set to None if cluster_network_cidr (nullable) is None
        # and __fields_set__ contains the field
        if self.cluster_network_cidr is None and "cluster_network_cidr" in self.__fields_set__:
            _dict['cluster_network_cidr'] = None

        # set to None if cluster_network_host_prefix (nullable) is None
        # and __fields_set__ contains the field
        if self.cluster_network_host_prefix is None and "cluster_network_host_prefix" in self.__fields_set__:
            _dict['cluster_network_host_prefix'] = None

        # set to None if service_network_cidr (nullable) is None
        # and __fields_set__ contains the field
        if self.service_network_cidr is None and "service_network_cidr" in self.__fields_set__:
            _dict['service_network_cidr'] = None

        # set to None if api_vip (nullable) is None
        # and __fields_set__ contains the field
        if self.api_vip is None and "api_vip" in self.__fields_set__:
            _dict['api_vip'] = None
        ...
        # set to None if ingress_vip (nullable) is None
        # and __fields_set__ contains the field
        if self.ingress_vip is None and "ingress_vip" in self.__fields_set__:
            _dict['ingress_vip'] = None
        ...
        # set to None if machine_network_cidr (nullable) is None
        # and __fields_set__ contains the field
        if self.machine_network_cidr is None and "machine_network_cidr" in self.__fields_set__:
            _dict['machine_network_cidr'] = None

        # set to None if pull_secret (nullable) is None
        # and __fields_set__ contains the field
        if self.pull_secret is None and "pull_secret" in self.__fields_set__:
            _dict['pull_secret'] = None

        # set to None if ssh_public_key (nullable) is None
        # and __fields_set__ contains the field
        if self.ssh_public_key is None and "ssh_public_key" in self.__fields_set__:
        ...
        # set to None if hyperthreading (nullable) is None
        # and __fields_set__ contains the field
        if self.hyperthreading is None and "hyperthreading" in self.__fields_set__:
            _dict['hyperthreading'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2ClusterUpdateParams:
        """Create an instance of V2ClusterUpdateParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2ClusterUpdateParams.parse_obj(obj)

        _obj = V2ClusterUpdateParams.parse_obj({
            "name": obj.get("name"),
