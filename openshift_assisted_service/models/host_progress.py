...
class HostProgress(BaseModel):
    ...
    __properties = ["current_stage", "progress_info"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostProgress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HostProgress:
        """Create an instance of HostProgress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostProgress.parse_obj(obj)

        _obj = HostProgress.parse_obj({
