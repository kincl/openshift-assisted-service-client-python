...
class HostRegistrationResponse(BaseModel):
    ...
    next_step_runner_command: Optional[HostRegistrationResponseAllOfNextStepRunnerCommand] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostRegistrationResponse:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of next_step_runner_command
        if self.next_step_runner_command:
            _dict['next_step_runner_command'] = self.next_step_runner_command.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HostRegistrationResponse:
        """Create an instance of HostRegistrationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostRegistrationResponse.parse_obj(obj)

        _obj = HostRegistrationResponse.parse_obj({
            "kind": obj.get("kind"),
            "id": obj.get("id"),
            "href": obj.get("href"),
            ...
            "next_step_runner_command": HostRegistrationResponseAllOfNextStepRunnerCommand.from_dict(obj.get("next_step_runner_command")) if obj.get("next_step_runner_command") is not None else None
        })
        return _obj
